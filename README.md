...
So like every good maker, I decided to design and build my own Nerf blaster from scratch!
...
A photo of the working blaster, magazine well not attached. Also, note the different trigger (it ought never to have existed).
